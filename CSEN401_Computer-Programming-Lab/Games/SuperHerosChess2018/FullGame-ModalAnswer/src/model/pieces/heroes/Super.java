...
public class Super extends ActivatablePowerHero {
	...
	public void moveUpRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super is not allowed to move in this direction",this, Direction.UPRIGHT);
	}

	@Override
	public void moveUpLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super is not allowed to move in this direction",this, Direction.UPLEFT);
	}

	@Override
	public void moveDownRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super is not allowed to move in this direction",this, Direction.DOWNRIGHT);
	}

	@Override
	public void moveDownLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super is not allowed to move in this direction",this, Direction.DOWNLEFT);
	}
