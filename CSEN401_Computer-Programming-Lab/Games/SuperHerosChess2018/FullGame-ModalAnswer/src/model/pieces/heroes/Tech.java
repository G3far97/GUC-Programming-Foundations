...
public class Tech extends ActivatablePowerHero {
	...
	public void moveUp() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech is not allowed to move in this direction",this, Direction.UP);
	}

	@Override
	public void moveDown() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech is not allowed to move in this direction",this, Direction.DOWN);
	}

	@Override
	public void moveRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech is not allowed to move in this direction",this, Direction.RIGHT);
	}

	@Override
	public void moveLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech is not allowed to move in this direction",this, Direction.LEFT);
	}
