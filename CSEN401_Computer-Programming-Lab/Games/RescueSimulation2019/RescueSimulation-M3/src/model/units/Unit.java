...
public abstract class Unit implements Simulatable, SOSResponder {
	...
	public void respond(Rescuable r) throws IncompatibleTargetException, CannotTreatException {
		if(this instanceof Evacuator && r instanceof Citizen) {
			throw new IncompatibleTargetException(this, r, "Incompatible Target");
		}
		if(this instanceof FireTruck && r instanceof Citizen) {
			throw new IncompatibleTargetException(this, r, "Incompatible Target");
		}
		if(this instanceof GasControlUnit && r instanceof Citizen) {
			throw new IncompatibleTargetException(this, r, "Incompatible Target");
		}
